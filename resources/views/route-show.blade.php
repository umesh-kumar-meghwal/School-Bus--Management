...
<body class="bg-slate-100 font-sans antialiased min-h-screen p-4 md:p-8">
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            ...
            <div>
                <button onclick="window.location.href='/addroute?q={{ $school_email }}'" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-lg shadow-sm hover:shadow transition">
                    + Add New Route
                </button>
            </div>
        </div>
        ...
        @else
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-12 text-center max-w-md mx-auto mt-10">
                ...
                <button onclick="window.location.href='/addroute?q={{ $school_email }}'" class="inline-flex items-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-lg shadow transition">
                    + Create First Route
                </button>
            </div>
        @endif
